%% Effects of model parameters (MAX) on burst Figure S15A-C
K_coefficient =  -2:0.01:0;
on1_max =  linspace(log10(0.005),log10(0.2),10);
rec_max =  linspace(log10(0.010),log10(0.2),10);

output_size = size(K_coefficient,2);
output_size1 = size(rec_max,2);
...
%         params.k_on1_max = 10^on1_max(i);
        params.k_recruitment_max  = 10^rec_max(i);
